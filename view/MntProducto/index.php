	...
	<div class="page-content">
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-lg-2">
					<div>
						<input type="button" name="action" id="newproveedor" value="Nuevo Proveedor" class="btn btn-rounded btn-primary">
					</div>
				</div>
			</div>
			<section class="box-typical box-typical-padding">
				<form method="post" id="product_form">
					...
					<div class="form-group">
								<label class="form-label" for="prod_nom">Nombre Porducto</label>
							...
							<div class="form-group">
								<label class="form-label" for="fech_venc">Fecha de Vencimiento</label>
								<div class="form-group">
							...
							<div class="form-group">
								<label class="form-label" for="prod_numl">Número de Lote</label>
								<input type="text" class="form-control" id="prod_numl" name="prod_numl" placeholder="Ingrese Número" required>
							</div>
							<div class="form-group">
								<label class="form-label" for="prove">Proveedor</label>
						...
						<div class="modal-footer">
							...
							<button type="button" name="action" id="elim_produ" value="add" class="btn btn-rounded btn-primary">Eliminar</button>                    						</div>
            	</form>
			</section>
        </div>
    </div>
