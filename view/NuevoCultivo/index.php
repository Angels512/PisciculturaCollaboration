...
<html>
    <head lang="es-419">
        ...
        <title>Crear Cultivo - Piscicultura</title>
    </head>
                ...
                <div class="box-typical box-typical-padding">
                    ...
                    <div class="row">
                        ...
                        <form action="" method="post" id="cultivoForm">
                            ...
                            <div class="col-lg-12">
                                <button type="submit" name="action" value="add" class="btn btn-rounded btn-inline btn-primary float-right mg-top">Agregar Cultivo</button>
                            </div>
                        </form>
