<?php 
    ...
    switch($_GET["op"]){
        ...
        // Para registrar los Parametros FQ //
        case "insertParafq":
        ...
        //para llenar el datatable de parafq por cultivo
        case "listar_x_cult":
        ...
        // Extrae todos los datos del formato oarametros fq para mostrarlos en su formulario
        case 'listarDatosParafq':
            ...
            if (is_array($datos) == true AND count($datos)>0)
            {
                foreach ($datos as $row)
                {
                    ...
                    $output["rango_nitrito"] = $row["rango_nitrito"];
        ...
        // Para actualizar el formato de parametros fq por su id
        case "editar":
        ...
        //para eliminar un formato de parametros fq por su id
        case "eliminar":
