    ...
    switch($_GET["op"]){
        ...
        case "listar_x_cult":
            ...
            foreach($datos as $row){
                ...
                $sub_array[] = '<button type="button" onClick="consultar('.$row['id_est_acui'].');"  class="btn btn-inline btn-primary btn-sm ladda-button"><i class="fa fa-eye"></i></button>';
                $sub_array[] = '<button type="button" onClick="editar('.$row['id_est_acui'].');"  class="btn btn-inline btn-warning btn-sm ladda-button"><div><i class="fa fa-edit"></i></div></button>';
                $sub_array[] = '<button type="button" onClick="eliminar('.$row['id_est_acui'].');" class="btn btn-inline btn-danger btn-sm ladda-button"><div><i class="fa fa-trash"></i></div></button>';
