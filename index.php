...
<html lang="es">
	...
	<body class="body-wrapper" data-spy="scroll" data-target=".privacy-nav">
			...
			<div class="container">
				<div class="row align-items-center">
					...
					<div class="col-md-6 text-center order-1 order-md-2">
						<img class="img-fluid" src="public/img/home/mobile.png" alt="screenshot">
					</div>
				</div>
			</div>
		</section>
		...
		=            Services            =
		===============================-->
		<section class="service section bg-gray" id="modules">
		...
		=            Testimonial            =
		==================================-->
		<section class="section testimonial" id="functions">
			<div class="container">
				<div class="row">
		...
		<!-- To Top -->
		<div class="scroll-top-to"> <i class="ti-angle-up"></i> </div>
		...
		<script src="public/plugins/aos/aos.js"></script>
		<!-- google map -->
		<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAgeuuDfRlweIs7D6uo4wdIHVvJ0LonQ6g"></script>
		<script src="public/plugins/google-map/gmap.js"></script>
